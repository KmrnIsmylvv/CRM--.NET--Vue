<template>
	<popup-form
		:actions="actions"
		:title="$t('systemManagement.groupUpdate')"
		>
		<v-container>
			<v-row>
				<v-col cols=12>
...
import { Vue, Component, Watch, Prop, Model, Mixins } from 'vue-property-decorator';
...
export default class GroupUpdate extends Mixins(DialogMixin, ValidationMixin) {
	@Prop({ required: true }) public model!: GroupUpdateModel;
