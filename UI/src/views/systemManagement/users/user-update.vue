<template>
	<popup-form
		:actions="actions"
		:title="$t('systemManagement.userUpdate')"
		>
		<v-container>
			<v-row>
				<v-col cols=12>
...
export default class UserUpdate extends Mixins(ValidationMixin, DialogMixin) {
	@Prop({ required: true }) public model!: UserUpdateModel;
